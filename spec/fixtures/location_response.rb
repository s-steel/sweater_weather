{:info=>{:statuscode=>0, :copyright=>{:text=>"© 2021 MapQuest, Inc.", :imageUrl=>"http://api.mqcdn.com/res/mqlogo.gif", :imageAltText=>"© 2021 MapQuest, Inc."}, :messages=>[]},
 ...
 :results=>
  [{:providedLocation=>{:location=>"Tillamook,OR"},
    :locations=>
     [{:street=>"",
       :adminArea6=>"",
       ...
       :mapUrl=>
        "http://www.mapquestapi.com/staticmap/v5/map?key=v1GRe2i4bownpluDvxVyZ4WVV3SceSPM&type=map&size=225,160&locations=45.456045,-123.838253|marker-sm-50318A-1&scalebar=true&zoom=12&rand=1176025857"}]}]}